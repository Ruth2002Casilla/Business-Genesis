namespace BusinessGenesis.Models
    {
        public class AliadosClaves
        {
            ...
            public string TipoDeSocios { get; set; } // Lista de respuestas seleccionadas (checkbox)

            // Pregunta 2: ¿Qué funciones o actividades dependen de estos aliados?
            public string FuncionesDeAliados { get; set; } // Lista de respuestas seleccionadas (checkbox)

            // Pregunta 3 ¿Cómo eliges a tus socios o aliados?
            public string CriteriosDeSelecciónDeSocios { get; set; } // Lista de respuestas seleccionadas (checkbox)
