namespace BusinessGenesis.Models
{
    public class Canales
    {
        ...
        public List<string> CanalesDeEntrada { get; set; } // Lista de respuestas seleccionadas (checkbox)

        // Pregunta 2: ¿Dónde compran o adquieren tu producto?
        public List<string> CanalesDeCompra { get; set; } // Lista de respuestas seleccionadas (checkbox)

        // Pregunta 3: ¿Cómo entregas tu producto o servicio al cliente?
        public List<string> CanalesDeEntrega { get; set; } // Lista de respuestas seleccionadas (checkbox)
        ...
        public List<string> EtapasCubiertas { get; set; } // Lista de respuestas seleccionadas (checkbox)
    }
