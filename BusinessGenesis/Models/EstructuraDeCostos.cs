namespace BusinessGenesis.Models
{
    public class EstructuraDeCostos
    {
        ...
        public string CostosEsenciales { get; set; } // Lista de respuestas seleccionadas (checkbox)

        // Pregunta 2: ¿Qué costos fijos tienes en tu negocio?
        public string CostosFijos { get; set; } // Lista de respuestas seleccionadas (checkbox)

        // Pregunta 3: ¿Qué costos variables dependen de la demanda de tus productos o servicios?
        public string CostosVariables { get; set; } // Lista de respuestas seleccionadas (checkbox)

        // Pregunta 4: ¿Cómo planeas reducir o optimizar estos costos?
        public string EstrategiasDeReduccionDeCostos { get; set; } // Lista de respuestas seleccionadas (checkbox)
